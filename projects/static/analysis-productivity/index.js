const PROJECT_BASE = '/projects/analysis-productivity';
const PROJECTS_STATIC = '/projects/static/analysis-productivity';
const textColorFiles = [`${PROJECTS_STATIC}/red.txt`, `${PROJECTS_STATIC}/green.txt`, `${PROJECTS_STATIC}/blue.txt`, `${PROJECTS_STATIC}/purple.txt`];
read_code_text();
...
async function read_code_text() {
    ...
    fetch(`${PROJECTS_STATIC}/code.txt`)
...
function getResult(section) {
    var fetch_section = `${PROJECT_BASE}/section_${section}`;
    fetch(fetch_section)
...
function uploadFile() {
    ...
    fetch(`${PROJECT_BASE}/upload`, { method: 'POST', body: formData })
        .then(response => response.json())
        .then(data => {
            //Table output
...
function printCSV() {
    fetch(`${PROJECT_BASE}/print_csv_headers`)
        .then(response => response.json())
        .then(data => {
            //Table output
            let table_output = document.getElementById('output');
...
function printFilteredCSV() {
    fetch(`${PROJECT_BASE}/print_filtered_csv`)
        .then(response => response.json())
        .then(data => {
            let table_output = document.getElementById('output');
