...
async function loadFlashcards() {
  const res = await fetch('/projects/study-vault/api/flashcards');
  if (!res.ok) throw new Error('Failed to load flashcards');
  return await res.json();
}

async function loadCatalog() {
  const res = await fetch('/projects/study-vault/api/catalog');
  if (!res.ok) throw new Error('Failed to load dashboard catalog');
  return await res.json();
}

async function loadCaseScenarios() {
  const res = await fetch('/projects/study-vault/api/case-scenarios');
  if (!res.ok) throw new Error('Failed to load case scenarios');
  return await res.json();
}

async function loadSyntaxRows() {
  const res = await fetch('/projects/study-vault/api/syntax');
  if (!res.ok) throw new Error('Failed to load syntax rows');
  return await res.json();
}

async function loadMgmtRows() {
  const res = await fetch('/projects/study-vault/api/terms');
...
async function loadCtrlCPrompts() {
  const res = await fetch('/projects/study-vault/api/ctrl-c-prompts');
...
async function loadNotes() {
  const res = await fetch('/projects/study-vault/api/notes');
...
async function loadProductivity() {
  const res = await fetch('/projects/study-vault/api/productivity');
  if (!res.ok) throw new Error('Failed to load productivity data');
  return await res.json();
}

async function loadStudyStats() {
  const res = await fetch('/projects/study-vault/api/study-stats');
...
async function saveHours(date, hours) {
  const res = await fetch('/projects/study-vault/api/productivity/log', {
    method: 'POST',
...
async function saveNote(date, note) {
  const res = await fetch('/projects/study-vault/api/productivity/note', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function deleteStudyDay(date) {
  const res = await fetch('/projects/study-vault/api/productivity/delete', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function importFunctionCsvText(text) {
  const res = await fetch('/projects/study-vault/api/import/functions', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function importParameterCsvText(text) {
  const res = await fetch('/projects/study-vault/api/import/parameters', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ text }),
  });
...
async function importQuestionCsvText(text) {
  const res = await fetch('/projects/study-vault/api/import/questions', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ text }),
  });
...
async function importSyntaxCsvText(text) {
  const res = await fetch('/projects/study-vault/api/import/syntax', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ text }),
  });
...
async function importMgmtCsvText(text) {
  const res = await fetch('/projects/study-vault/api/import/terms', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ text }),
  });
