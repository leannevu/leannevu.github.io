...
async function fetchSprint() {
    try {
        const response = await postForm('/projects/scrum/api/fetch_sprint');
        ...
        if (currentPhaseImgUrl) {
            htmlContent += `
                <img 
                    src="/projects/static/scrum/${currentPhaseImgUrl}.jpg" 
                    width="500" 
                    height="300" 
                    alt="${currentPhase}"
                >
...
async function updateSprint(update) {
    try {
        ...
        const response = await postForm('/projects/scrum/api/update_phase', {
...
async function fetchUserStories() {
    try {
        ...
        const response = await postForm('/projects/scrum/api/fetch_sprint_stories', requestData);
...
async function fetchTeamMembers() {
    ...
    try {
        const response = await postForm('/projects/scrum/api/fetch_assign_members', {
...
async function fetchStoryPoints() {
    ...
    try {
        const response = await postForm('/projects/scrum/api/fetch_story_points', {
            itemText: userStoryName
        });
...
async function updateStoryStatus(update) {
    ...
    try {
        ...
        const response = await postForm('/projects/scrum/api/update_status', {
